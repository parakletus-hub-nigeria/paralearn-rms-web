        ...
        <div className="w-full">
           <Header schoolLogo="https://arua.org/wp-content/themes/yootheme/cache/d8/UI-logo-d8a68d3e.webp"/>
            ...
            <div className="flex flex-col md:flex-row items-center justify-evenly gap-4 md:gap-0 px-[20px] md:px-0">
                {
                    vv.map((items, index) => (
                        <div key={index} className="py-[20px] md:py-[30px] px-[20px] flex flex-row items-center rounded-lg w-full md:w-[23%] space-x-4" style={{ backgroundColor: items.bg_color }}>
                            <items.icon className="rounded-[50%] p-[10px] text-white size-[30px] md:size-[40px]" style={{ backgroundColor: items.icon_color }} />
                            <div>
                                <p className="font-semibold text-sm md:text-base">{items.title}</p>
            ...
            <div className="flex flex-col lg:flex-row mt-[25px] justify-between gap-8 lg:gap-0 px-[20px]  lg:px-0">
                <div className="w-full lg:w-[40%] h-auto lg:h-[450px] flex flex-col justify-evenly ">
                    ...
                    {upcomingExams.map((item,index) => (
                        <div key={index} className="flex flex-col md:flex-row items-center rounded-[12px] overflow-hidden h-[120px]  border-[1px] border-gray-400 shadow-xl shadow-gray-400 my-2 md:my-0">
                            ...
                            <div className="w-full md:w-[85%] p-2">
                                ...
                                <div className="flex flex-col md:flex-row items-start md:items-center space-x-0 md:space-x-[10px] justify-between gap-2 md:gap-0">
                                    <div>
                                        <p className="font-semibold text-xs md:text-sm">{item.studentCount} Students</p>
                                        <p className="font-semibold text-xs md:text-sm">{item.questionCount} Questions</p>
                                    </div>
