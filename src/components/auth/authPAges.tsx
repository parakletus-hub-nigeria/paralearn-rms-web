...
export function PageOne({data,changeData,step,setStep}: any){
    ...
    const [nameAuth,setNameAuth] = useState(() => checkName(data["adminEmail"]))
    ...
    return <div className="my-[25px] border-[1px] border-[#641BC4] rounded-[6px] w-[95%] sm:w-[45%] flex flex-col items-center justify-between py-[40px] h-[445px]">
        ...
        <div className="w-[90%] space-y-3">
            ...
            <div className="flex flex-col w-[100%] p-[10px]">
                ...
                <input type="text" name="subdomain" value={data["schoolName"]} onChange={(e) => {changeData(e)}} className="border-[1px] border-gray-300 focus:border-[2px] focus:outline-none h-[45px] w-[90%] p-[13px]" readOnly/> 
    ...
    const forms = [
   {
    ...
    return <div className="my-[25px] border-[1px] border-[#641BC4] rounded-[6px]w-[95%] sm:w-[45%] flex flex-col items-center justify-between py-[40px] h-[445px]">
        ...
        <div className="w-[90%] space-y-3">
            ...
            <div className="flex flex-col w-[100%] ">
                <label htmlFor={form.name}>{form.label}</label>
                <input type={form.type} name={form.name} value={data[form.name]} onChange={(e) => {changeData(e);checkPhone(e.target.value)}} className="border-[1px] border-[#641BC4] focus:border-[2px] focus:outline-none h-[45px] w-[100%] p-[13px]"/>
                <p className="text-[12px]">{form.subtext}</p>
            </div>
        ))}
        <div className=" w-[100%] mb-2 ">
            <input type="checkbox" name="agreement" value={data.agreement} onChange={(e) => changeData(e)} className="mr-2"/>
        ...
        {/* submit button */}
            ...
            back </button>
            {/* create school */}
                <button onClick={() => {}} disabled={!phoneAuth || !agreement} style={!phoneAuth || !agreement? {backgroundColor:"#a166f0"} : {backgroundColor:"#641BC4"}} className="w-[35%] rounded-[12px] bg-[#641BC4] font-semibold text-white h-[52px] flex flex-row items-center justify-center">
