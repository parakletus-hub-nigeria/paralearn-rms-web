      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-24 py-16 md:py-24">
        ...
        <div className="space-y-8 max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl p-8 shadow-md space-y-6">
            ...
            <section>
              <h2 className="text-2xl font-black text-slate-900 mb-4">Types of Cookies We Use</h2>
              <p className="text-slate-600 mb-4">
            ...
            <section>
              <h2 className="text-2xl font-black text-slate-900 mb-4">Managing Cookies</h2>
              <p className="text-slate-600 mb-4">
