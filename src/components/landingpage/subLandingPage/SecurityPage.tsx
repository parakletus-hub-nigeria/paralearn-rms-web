    ...
    <LandingLayout className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-24 py-16 md:py-24">
        <div className="text-center mb-12 md:mb-16">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 mb-4 tracking-tight">
            Security
          </h1>
        ...
        <div className="space-y-8 max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl p-8 shadow-md space-y-6">
            <section>
              <h2 className="text-2xl font-black text-slate-900 mb-4">Data Encryption</h2>
            ...
            <section>
              <h2 className="text-2xl font-black text-slate-900 mb-4">Secure Storage</h2>
              <p className="text-slate-600 mb-4">
            ...
            <section>
              <h2 className="text-2xl font-black text-slate-900 mb-4">Access Controls</h2>
              <p className="text-slate-600 mb-4">
            ...
            <section>
              <h2 className="text-2xl font-black text-slate-900 mb-4">Regular Security Audits</h2>
              <p className="text-slate-600 mb-4">
            ...
            <section>
              <h2 className="text-2xl font-black text-slate-900 mb-4">Report Security Issues</h2>
