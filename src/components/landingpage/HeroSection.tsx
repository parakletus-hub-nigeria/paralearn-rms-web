    ...
    <section className="w-full px-6 md:px-12 lg:px-20 py-12 md:py-20">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 md:mb-24">
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl text-hero leading-tight animate-fade-in">
            Empowering Educators,
          </h1>
          <h2
            className="font-display text-3xl md:text-4xl lg:text-5xl text-hero font-semibold mt-2 animate-fade-in"
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          >
            <p className="text-foreground/80 font-body text-base md:text-lg leading-relaxed mb-8">
              Paralearn LMS is an intuitive, feature-packed learning platform
