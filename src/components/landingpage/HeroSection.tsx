...
const HeroSection = () => {
  ...
  return (
    <section className="w-full relative overflow-hidden min-h-screen pt-24 md:pt-32 lg:pt-28 xl:pt-28 2xl:pt-0 pb-2 md:pb-4 lg:pb-6 xl:pb-8 2xl:pb-10">
      ...
      <div className="absolute top-20 right-10 w-72 h-72 bg-purple-400/20 dark:bg-purple-600/10 rounded-full blur-3xl opacity-60" />
      <div className="absolute bottom-20 left-10 w-96 h-96 bg-indigo-400/15 dark:bg-indigo-600/8 rounded-full blur-3xl opacity-50" />
      ...
      <div className="flex flex-col lg:flex-row h-full min-h-screen items-start md:items-center justify-start md:justify-center lg:items-center pt-8 md:pt-0 lg:pt-0 relative z-10">
        ...
        <div className="hidden lg:flex w-full lg:w-1/2 items-center justify-center p-8 lg:p-12 xl:p-16 2xl:p-20">
          <div className="relative w-full h-full max-w-[90%] xl:max-w-full group">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-primary/30 via-purple-500/25 to-indigo-500/30 rounded-2xl blur-3xl group-hover:blur-[40px] transition-all duration-700 opacity-60 group-hover:opacity-80 -z-10" />
            
            {/* Floating orbs for depth */}
            <div className="absolute -top-10 -right-10 w-32 h-32 bg-purple-400/30 dark:bg-purple-600/20 rounded-full blur-2xl opacity-60" />
            <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-indigo-400/25 dark:bg-indigo-600/15 rounded-full blur-2xl opacity-50" />
