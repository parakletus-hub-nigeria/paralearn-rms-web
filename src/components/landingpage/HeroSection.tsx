...
const HeroSection = () => {
  return (
    <section className="w-full relative overflow-hidden min-h-screen pt-28 md:pt-32 lg:pt-0">
      {/* Two Column Layout: Text Left, Image Right */}
      <div className="flex flex-col lg:flex-row h-full min-h-screen items-start md:items-center justify-start md:justify-center lg:items-center pt-12 md:pt-0">
        {/* Left Column: Hero Text Content */}
        <div className="w-full lg:w-1/2 flex flex-col justify-start md:justify-center items-center lg:items-start space-y-4 md:space-y-5 lg:space-y-8 xl:space-y-10 py-8 md:py-6 lg:py-0 px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24">
          {/* Headline - Mobile: text-5xl, Tablet: text-5xl, Desktop: text-6xl, Large: text-7xl */}
          <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-7xl font-black leading-[1.15] tracking-tight text-slate-900 dark:text-white text-center lg:text-left max-w-2xl">
            Restore Calm to Your School's Administration
          </h1>
          
          {/* Subheadline - Mobile: text-base, Tablet: text-lg, Desktop: text-xl, Large: text-2xl */}
          <p className="text-sm md:text-base lg:text-lg xl:text-xl 2xl:text-2xl text-slate-700 dark:text-slate-300 leading-relaxed font-medium text-center lg:text-left max-w-xl">
          ...
          <div className="flex items-center justify-center py-4 md:py-5 lg:hidden w-full -mx-6 md:mx-0">
          ...
          <div className="flex flex-row flex-wrap items-center justify-center lg:justify-start gap-3 md:gap-4 lg:gap-6 xl:gap-8 pt-3 md:pt-5 lg:pt-8 w-full">
            <Button
